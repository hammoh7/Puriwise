  ...
  useEffect(() => {
    ...
    const drawHeatmapVisualization = (
      ...
      dataPoints.forEach((point, index) => {
        ...
        if (point.type === "pollution") {
          color = `rgba(239, 68, 68, ${
            point.intensity * 0.6 * pulseIntensity
          })`;
      ...
      drawLegend(
        ...
        w,
        h,
        ["High Pollution", "Moderate", "Clean Air"],
    ...
    const drawAIVisualization = (
      ...
      nodes.forEach((node, index) => {
        ...
        ctx.fillStyle =
          index < 3 ? "#3b82f6" : index < 5 ? "#10b981" : "#f59e0b";
        ctx.fill();
